...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 시나리오를 작업자 풀에 할당하려면 Fusion 관리자여야 합니다. </td>
   </tr>
 </tbody> 
</table>
...
1. 하나 이상의 시나리오를 폴더로 이동하려면 이동하려는 각 시나리오 옆에 있는 확인란을 클릭한 다음 화면 하단의 막대에서 **폴더로 이동**&#x200B;을 클릭합니다. 표시되는 창에서 시나리오를 이동할 폴더를 선택한 다음 **이동**&#x200B;을 클릭합니다.
