...
# Workfront Fusion 릴리스 활동: 2025년 5월 12일 주간

이 페이지에서는 2025년 5월 12일 화요일이 있는 주에 Adobe Workfront Fusion에서 이루어진 모든 개선 사항을 설명합니다.
...
Azure DevOps에서 연결을 구성할 때 모든 범위를 더 쉽게 요청할 수 있도록 새로운 유형의 연결을 만들었습니다. Azure DevOps EntraApp 연결 유형에는 연결에 대한 모든 범위를 요청할 수 있는 토글이 포함되어 있습니다.

Azure DevOps 커넥터에서 인증서 인증을 구성하는 방법에 대한 지침은 Azure DevOps 모듈 문서에서 [Workfront Fusion에 연결 [!DNL Azure DevOps] 을 참조하십시오.](/help/workfront-fusion/references/apps-and-modules/third-party-connectors/azure-dev-ops.md#connect-azure-devops-to-workfront-fusion)
