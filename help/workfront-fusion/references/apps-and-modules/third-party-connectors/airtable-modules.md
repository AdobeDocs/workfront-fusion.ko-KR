...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p>레코드</p> </td> 
   <td> <p>새 레코드에 대한 값을 입력합니다. 사용 가능한 필드는 선택한 테이블을 기반으로 합니다.</p> 
   <!--
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p>레코드</p> </td> 
   <td> <p>새 레코드에 대한 값을 입력합니다. 사용 가능한 필드는 선택한 테이블에 따라 다릅니다.</p> 
   <!--
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><code>https://api.airtable.com/</code>과 관련된 경로를 입력합니다. 예: <code>v0/{base}/{table}</code> </td> 
  </tr> 
  <tr> 
