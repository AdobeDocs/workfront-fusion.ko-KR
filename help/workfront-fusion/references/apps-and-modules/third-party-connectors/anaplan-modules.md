---
title: Anaplan 모듈
description: Adobe Workfront Fusion 시나리오에서는 Anaplan을 사용하는 워크플로를 자동화하고 여러 타사 애플리케이션 및 서비스에 연결할 수 있습니다.
author: Becky
...
Adobe Workfront Fusion 시나리오에서는 [!DNL Anaplan]를 사용하는 워크플로를 자동화할 수 있으며 여러 제3자 애플리케이션 및 서비스에 연결할 수 있습니다.
...
* Workfront Fusion이 작업 공간, 모델 및 [!UICONTROL Anaplan] 계정의 [!DNL Anaplan] 개체를 상호 작용하려면 먼저 해당 개체를 구성해야 합니다.
...
## [!DNL Anaplan]를 Workfront Fusion에 연결 {#connect-anaplan-to-workfront-fusion}

사용자의 [!DNL Anaplan] 모듈에 연결하려면:
...
[!DNL Anaplan] 모듈을 구성할 때 Workfront Fusion은 아래 나열된 필드를 표시합니다. 이와 함께 앱 또는 서비스의 액세스 레벨과 같은 요인에 따라 추가적인 [!DNL Anaplan] 필드가 표시될 수 있습니다. 모듈의 굵은 글씨 제목은 필수 필드를 나타냅니다.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   ...
   <td>[!DNL Anaplan]에 대한 연결을 만드는 방법에 대한 지침은 이 문서에서 <a href="#connect-anaplan-to-workfront-fusion" class="MCXref xref">Workfront Fusion에 [!DNL Anaplan] 연결</a>을 참조하십시오.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>읽을 레코드 종류를 선택하십시오.</p> 
    <ul> 
     ...
     <li> <p><b>작업 공간</b> </p> <p>읽으려는 Workspace의 ID를 선택하거나 매핑합니다.</p> </li> 
