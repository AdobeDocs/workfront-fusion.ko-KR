...
description: '[!DNL Adobe Workfront Fusion Frame].io 모듈을 사용하면 [!DNL Frame.io] 계정의 자산 및 주석을 모니터링, 만들기, 업데이트, 검색 또는 삭제할 수 있습니다.'
author: Becky
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p><code>https://api.frame.io</code>과 관련된 경로를 입력합니다. 예: <code> /v2/teams</code></p> <p>참고: 사용 가능한 엔드포인트 목록은 [!DNL Frame.io] API 참조를 참조하십시오.</p> </td> 
  </tr> 
  <tr> 
