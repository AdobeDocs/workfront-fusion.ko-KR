...
Adobe Workfront Fusion 시나리오에서는 [!DNL Adobe Lightroom]를 사용하는 워크플로를 자동화할 수 있으며 여러 제3자 애플리케이션 및 서비스에 연결할 수 있습니다.
...
사용자의 [!DNL Adobe Lightroom] 모듈에 연결하려면:
...
[!DNL Adobe Lightroom] 모듈을 구성할 때 Workfront Fusion은 아래 나열된 필드를 표시합니다. 이와 함께 앱 또는 서비스의 액세스 레벨과 같은 요인에 따라 추가적인 [!DNL Adobe Lightroom] 필드가 표시될 수 있습니다. 모듈의 굵은 글씨 제목은 필수 필드를 나타냅니다.
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    <tr>
      ...
      <td>[!DNL Adobe Lightroom]에 연결하는 방법에 대한 지침은 이 문서에서 <a href="#create-a-connection-to-adobe-lightroom" class="MCXref xref" >[!DNL Adobe Lightroom]</a>에 연결하기를 참조하십시오.</td>
    </tr>
    <tr>
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      <td role="rowheader">[!UICONTROL 스택 내에 있는 자산을 숨길까요?"]</td>
      <td>
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>한 실행 주기 동안 Workfront Fusion이 반환할 최대 에셋 수를 설정합니다. 이 필드의 기본값은 100입니다. 제한 경계의 여러 앨범에 동일한 <code>name_after</code> 값이 있는 경우 이 모듈은 이 제한보다 더 많은 앨범을 반환할 수 있습니다.</p>
      </td>
    </tr>
  </tbody>
</table>
