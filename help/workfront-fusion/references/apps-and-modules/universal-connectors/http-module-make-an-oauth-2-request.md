...
# [!UICONTROL HTTP] > [!UICONTROL OAuth 2.0 요청하기] 모듈
...
[!UICONTROL HTTP] > [!UICONTROL OAuth 2.0 요청 만들기] 모듈을 구성하면 Workfront Fusion에 아래 나열된 필드가 표시됩니다. 모듈의 굵은 글씨 제목은 필수 필드를 나타냅니다.
