...
1. 데이터 저장소를 만들거나 편집할 때 데이터 구조 필드 옆에 있는 **[!UICONTROL 추가]**&#x200B;를 클릭합니다.
...
1. 편집할 데이터 저장소 옆의 확인란을 클릭한 다음 화면 하단의 배너에서 **편집**&#x200B;을 클릭합니다.
...
1. 편집할 데이터 저장소 옆의 확인란을 클릭한 다음 화면 하단의 배너에서 **찾아보기**&#x200B;를 클릭합니다.
1. (선택 사항) **[!UICONTROL 추가]**&#x200B;를 클릭한 다음 새 항목에 대한 정보를 입력하여 데이터 저장소에 새 항목을 추가합니다.
1. (선택 사항) 해당 항목에 대한 확인란을 클릭한 다음 화면 오른쪽 상단에서 **선택한 항목 삭제** 또는 **모두 삭제**&#x200B;를 클릭하여 데이터 저장소에서 하나 이상의 항목을 삭제합니다.
1. **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
