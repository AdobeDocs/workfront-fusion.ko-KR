...
## Workfront를 Workfront Fusion에 연결
...
모듈은 웹후크와 관련된 모든 이벤트 구독을 표시합니다. 여기에는 Fusion을 통해 생성된 이벤트 구독뿐만 아니라 API를 통해 직접 생성된 이벤트 구독도 포함됩니다. 이 이벤트 구독 보기는 이전 버전의 이벤트 보기 모듈에서 사용할 수 없습니다.
