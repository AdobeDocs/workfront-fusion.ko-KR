---
title: Google Team Drive 모듈
description: '[!DNL Adobe Workfront Fusion Google Team Drive] 모듈을 사용하면 파일을 모니터링, 업로드, 업데이트, 복사, 삭제 또는 검색하고 [!DNL Google Shared] 드라이브에서 폴더를 만들 수 있습니다.'
author: Becky
...
Adobe Workfront Fusion에서 [!DNL Google Team Drive]을(를) 사용하려면 [!DNL Google Workspace] 계정이 있어야 합니다. 계정이 없으면 [[!DNL Google Workspace] 등록 사이트](https://workspace.google.com/business/signup/welcome)에서 [!DNL Google Workspace] 계정을 만들 수 있습니다.

Adobe Workfront Fusion 시나리오에서는 [!DNL Google Team Drive]를 사용하는 워크플로를 자동화할 수 있으며 여러 제3자 애플리케이션 및 서비스에 연결할 수 있습니다.
...
[!DNL Google Team Drive] 모듈을 구성할 때 Workfront Fusion은 아래 나열된 필드를 표시합니다. 이와 함께 앱 또는 서비스의 액세스 레벨과 같은 요인에 따라 추가적인 [!DNL Google Team Drive] 필드가 표시될 수 있습니다. 모듈의 굵은 글씨 제목은 필수 필드를 나타냅니다.
