...
ht-degree: 16%
---
# Workfront Fusion 릴리스 활동: 2024년 6월 3일 주간

이 페이지에서는 2024년 6월 3일 화요일이 있는 주에 Adobe Workfront Fusion에서 이루어진 모든 개선 사항을 설명합니다.
...
Workfront Fusion은 Adobe Experience Cloud를 통해 Fusion에 액세스하지 않는 사용자를 위해 업데이트되었습니다. 새로운 Fusion UI는 다른 Adobe 제품과의 보다 원활한 경험을 제공하고 Adobe Experience Cloud로의 사용자 전환을 원활하게 해 줍니다.

이전에는 Adobe Experience Cloud를 통해 Fusion에 액세스한 사용자와 액세스하지 않은 사용자의 경험이 상당히 달랐습니다.
