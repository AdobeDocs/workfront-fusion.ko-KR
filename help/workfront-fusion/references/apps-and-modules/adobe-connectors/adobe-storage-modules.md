...
사용자의 [!DNL Adobe Storage] 모듈에 연결하려면:
...
1. 다음 필드를 채웁니다.
   ...
   <table style="table-layout:auto"> 
      ...
      <tbody>
        ...
        <td>[!DNL Adobe] [!UICONTROL 클라이언트 암호]를 입력합니다. [!DNL Adobe Developer Console]에 있는 프로젝트의 [!UICONTROL 자격 증명 세부 정보] 섹션에서 찾을 수 있습니다.</td>
        </tr>
        <tr>
