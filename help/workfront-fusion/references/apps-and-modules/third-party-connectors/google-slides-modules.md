...
[!DNL Google Slides] 모듈을 구성할 때 Workfront Fusion은 아래 나열된 필드를 표시합니다. 이와 함께 앱 또는 서비스의 액세스 레벨과 같은 요인에 따라 추가적인 [!DNL Google Slides] 필드가 표시될 수 있습니다. 모듈의 굵은 글씨 제목은 필수 필드를 나타냅니다.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>값을 추가합니다.</p> 
    <ul> 
     <li><strong>[!UICONTROL 태그]</strong>: 프레젠테이션에서 바꿀 태그를 입력하십시오. 예: <code>&#123;&#123;Name&#125;&#125;</code></li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p><code>https://developers.google.com/slides/</code>과 관련된 경로를 입력합니다. E.g. 프레젠테이션.</p> <p>사용 가능한 끝점 목록은 <a href="https://developers.google.com/slides/reference/rest">[!DNL Google Slides] API 설명서</a>를 참조하세요.</p> </td> 
  </tr> 
  <tr> 
