...
* [문서](#document)
* [오브젝트](#object)
* [다중 파일 추출](#multi-file-extract)
* [다중 파일 로드](#multi-file-load)
* [파일 스테이징](#file-staging)
* [기타](#other)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>이러한 관계를 만들기 위해 제공하는 입력 유형을 선택합니다.</p> <ul><li>CSV로 내보내기</li><li>JSON</li></ul></td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>파일 데이터</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>입력 유형</p> </td> 
   <td> <p>이러한 관계를 삭제하기 위해 제공하는 입력 유형을 선택합니다.</p> <ul><li>CSV로 내보내기</li><li>JSON</li></ul></td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>파일 데이터</p> </td> 
   <td> <p>CSV 파일을 사용하는 경우 CSV 파일 데이터를 입력하거나 매핑합니다.</p> </td> 
...
* [여러 파일 추출](#extract-multiple-files)
* [추출 결과 검색](#retrieve-extract-results)

#### 여러 파일 추출

이 작업 모듈은 하나 이상의 데이터 파일을 추출하는 로더 작업을 생성합니다.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">데이터 파일</td> 
   <td>추출하려는 각 파일에 대해 <b>항목 추가</b>를 클릭하고 다음을 입력하십시오.
   <ul>
   <li>오브젝트 유형</li>
   <li>VQL 기준(선택 사항): 특정 기준을 충족하는 파일만 포함하도록 데이터 세트를 필터링하려면 저장소 쿼리 언어(VQL)에 기준을 입력합니다.</li>
   </ul>
    </td> 
  </tr> 
 </tbody> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>작업 ID</p> </td> 
   <td> <p>결과를 검색할 작업을 입력하거나 매핑합니다. 데이터 파일 추출 모듈에서 매핑할 수 있습니다.</p> </td> 
  </tr> 
  <tr> 
...
* [여러 파일 로드](#load-multiple-files)
* [로그 결과 검색](#retrieve-log-results)

#### 여러 파일 로드

이 모듈은 로더 작업을 생성하고 데이터 파일 세트를 로드합니다.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">파일</td> 
   <td>이 작업에서 사용할 CSV 파일에 파일 경로를 입력하거나 매핑합니다.</td> 
  </tr> 
  <tr> 
   <td role="rowheader">주문</td> 
   <td>파일 목록의 순서를 입력하거나 매핑합니다.</td> 
  </tr> 
  <tr> 
   <td role="rowheader">트리거 없음</td> 
   <td>레코드 또는 문서 트리거를 무시하려면 예를 선택합니다.</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>작업 ID</p> </td> 
   <td> <p>결과를 검색할 작업을 입력하거나 매핑합니다. 데이터 파일 로드 모듈에서 매핑할 수 있습니다.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">작업 ID</td> 
   <td> <p>결과를 검색할 작업을 입력하거나 매핑합니다. 데이터 파일 로드 모듈에서 매핑할 수 있습니다.</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>성공한 작업을 검색할지 실패한 작업을 검색할지 선택합니다.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
이 모듈은 지정된 경로에 대한 파일 및 폴더 목록을 반환합니다.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">홈 디렉터리 선택</td> 
   <td>항목을 나열할 홈 디렉터리를 선택합니다.</td> 
  </tr> 
  <tr> 
   <td role="rowheader">주문</td> 
   <td>파일 목록의 순서를 입력하거나 매핑합니다.</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><code>baseurl/api/v</code>과 관련된 경로를 입력합니다.  예: <code>/objects/documents</code>. <code>baseurl/api/v/</code>은(는) 이미 포함되어 있으므로 포함하지 마십시오.</td> 
  </tr> 
  <tr> 
