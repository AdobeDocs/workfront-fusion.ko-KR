...
1. **콜백 URL** 필드에 Workfront Fusion 데이터 센터를 기반으로 다음 URL 중 하나를 입력합니다.
   ...
   |---|---|
   | 미국 | `https://app.workfrontfusion.com/oauth/cb/workfront-jira2` |
...
* 리디렉션 URL
  ...
  |---|---|
  | 미국 | `https://app.workfrontfusion.com/oauth/cb/workfront-jira` |
...
PAT를 사용하려면 `jira-config.properties` 파일의 `jira/bin/WEB-INF/classes` 파일에서 다음을 사용하도록 설정해야 합니다.
  ...
  <tr> 
   ...
   <td> <p>레코드를 감시하는 데 사용할 웹후크를 선택하거나 새 웹후크를 만듭니다. </p> <p>새 웹후크를 생성하는 방법:</p> 
    <ol> 
     ...
     <li>이 모듈에 대한 Jira 쿼리 언어 필터를 입력합니다.<p>JQL에 대한 자세한 내용은 Atlassian 도움말 사이트에서 <a href="https://www.atlassian.com/blog/jira-software/jql-the-most-flexible-way-to-search-jira-14#:~:text=JQLstandsforJiraQuery,projectmanagers%2Candbusinessusers입니다.">JQL</a>을(를) 참조하십시오. </p></li>
