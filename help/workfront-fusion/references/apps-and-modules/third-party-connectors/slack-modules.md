...
Adobe Workfront Fusion 시나리오에서는 [!DNL Slack]를 사용하는 워크플로를 자동화할 수 있으며 여러 제3자 애플리케이션 및 서비스에 연결할 수 있습니다.
...
[!DNL Slack] 모듈을 구성할 때 Workfront Fusion은 아래 나열된 필드를 표시합니다. 이와 함께 앱 또는 서비스의 액세스 레벨과 같은 요인에 따라 추가적인 [!DNL Slack] 필드가 표시될 수 있습니다. 모듈의 굵은 글씨 제목은 필수 필드를 나타냅니다.
...
* [비공개 채널 메시지 받기](#get-a-private-channel-message)
* [공개 채널 메시지 받기](#get-a-public-channel-message)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!DNL Slack] 계정을 Workfront Fusion에 연결하는 방법에 대한 지침은 <a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">Adobe Workfront Fusion에 연결 만들기 - 기본 지침</a>을 참조하십시오.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL As User]</td> 
   <td>이 옵션을 활성화하면 이 모듈에 대한 연결에 사용된 자격 증명을 소유하는 사용자로 메시지를 업데이트합니다.</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL 첨부 파일]</td> 
   <td>메시지에 첨부할 각 항목에 대해 <b>항목 추가</b>를 클릭하고 항목의 세부 정보를 입력하십시오.</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>한 실행 주기 동안 Workfront Fusion이 반환할 최대 메시지 수를 설정합니다.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL 제한] </td> 
   <td> <p>한 실행 주기 동안 Workfront Fusion이 반환할 최대 채널 수를 설정합니다.</p> </td> 
  </tr> 
 </tbody> 
</table>
</table>
...
<tr> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL 제한] </td> 
   <td> <p>한 실행 주기 동안 Workfront Fusion이 반환할 최대 멤버 수를 설정합니다.</p> </td> 
  </tr> 
 </tbody> 
</table>
