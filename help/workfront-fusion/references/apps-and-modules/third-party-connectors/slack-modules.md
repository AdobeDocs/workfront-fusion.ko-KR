...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>채널 ID를 입력(매핑)합니다.</p> <p>참고: 채널 ID는 [!UICONTROL List Channels] 모듈을 사용하여 검색할 수 있습니다.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Channel ID]</p> </td> 
   <td> <p>채널 ID를 입력하거나 매핑합니다.</p> <p>참고: 채널 ID는 [!UICONTROL List Channels] 모듈을 사용하여 검색할 수 있습니다.</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>메시지를 만들 채널을 선택하는 방법을 선택하십시오.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p><strong>[!UICONTROL Channel ID or name]</strong> 필드에 메시지를 게시할 채널의 채널 ID 또는 이름을 입력하거나 매핑합니다.</p> <p>참고: 채널 ID는 [!UICONTROL List Channels] 모듈을 사용하여 검색할 수 있습니다.</p> </li> 
     <li> <p><strong>[!UICONTROL Select from the list]</strong> </p> <p>채널 유형을 선택한 다음 채널을 선택합니다.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>다음 두 가지가 모두 적용되는 경우 <strong>[!UICONTROL Yes]</strong>을(를) 선택하십시오.</p> 
    <ul> 
  ...
  <tr> 
   ...
   <td> <p>자동 구문 분석을 허용하려면 이 옵션을 활성화합니다. </p> <p>자세한 내용은 [!DNL Slack] 설명서에서 <a href="https://api.slack.com/docs/formatting">앱 표면에 대한 텍스트 서식 지정</a>을 참조하십시오.</p> <p>참고: 원래 메시지에서 [!UICONTROL Link names] 또는 [!UICONTROL Parse message text] 옵션을 사용한 경우 [!UICONTROL Update a Message] 모듈도 실행할 때 해당 옵션을 지정해야 합니다.</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>원하는 메시지를 선택하는 방법을 선택합니다 .</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p><strong>[!UICONTROL Channel ID or name]</strong> 필드에 메시지를 포함하는 채널의 채널 ID 또는 을 입력하거나 매핑한 다음 메시지의 <strong>[!UICONTROL Time Stamp (Message ID)]</strong>을(를) 입력합니다. .</p> <p>참고: 채널 ID는 [!UICONTROL List Channels] 모듈을 사용하여 검색할 수 있습니다.</p> </li> 
     <li> <p><strong>[!UICONTROL Select from the list]</strong> </p> <p>채널 유형을 선택한 다음 채널을 선택하고 메시지를 선택합니다.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Text]</p> </td> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Parse message text]</p> </td> 
   <td> <p>자동 구문 분석을 허용하려면 이 옵션을 활성화합니다. </p> <p> 자세한 내용은 [!DNL Slack] 설명서에서 <a href="https://api.slack.com/docs/formatting">앱 표면에 대한 텍스트 서식 지정</a>을 참조하십시오.</p> <p>참고: 원본 메시지에서 [!UICONTROL Link names] 또는 [!UICONTROL Parse message text] 옵션을 사용한 경우 메시지 업데이트 모듈도 실행할 때 이 옵션을 지정해야 합니다.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>결과에서 보관된 채널을 제외하려면 [!UICONTROL Yes]을(를) 선택하십시오.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Type] </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Channel ID]</p> </td> 
   <td> <p>정보를 검색할 채널의 ID를 입력하거나 매핑합니다.</p> <p>참고: 채널 ID는 [!UICONTROL List Channels] 모듈을 사용하여 검색할 수 있습니다.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* **메신저**: [!UICONTROL Instant Message]
* **비공개 채널**: 이전 [!UICONTROL Group]
* **다이렉트 메시지**: 이전 [!UICONTROL IM]
* API 설명서의 **채널**: [!UICONTROL Conversation], [!DNL Slack] 앱의 [!UICONTROL channel].
