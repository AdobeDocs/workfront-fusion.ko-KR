---
title: Workfront Fusion의 AI 어시스턴트
description: Workfront Fusion의 AI 어시스턴트
author: Becky
...
# Workfront Fusion의 AI 어시스턴트

이 기능은 더 이상 사용되지 않으며 이 문서는 곧 제거될 예정입니다.
...
For more information on signing the agreement, see [Sign the Adobe Gen AI agreement](https://experienceleague.adobe.com/ko/docs/workfront/using/basics/ai-assistant/ai-assistant-overview#sign-the-adobe-gen-ai-agreement) in the article AI Assistant overview in the Workfront documentation.
