...
description: 이 Adobe Workfront Fusion 작업 모듈은 API 키 인증 권한이 필요한 지정된 URL에 HTTPS 요청을 보내고 응답을 처리합니다.
author: Becky
...
[!UICONTROL HTTP] > [!UICONTROL API 키 권한 부여 요청 만들기] 모듈을 구성하면 Adobe Workfront Fusion에 아래 나열된 필드가 표시됩니다. 모듈의 굵은 글씨 제목은 필수 필드를 나타냅니다.
