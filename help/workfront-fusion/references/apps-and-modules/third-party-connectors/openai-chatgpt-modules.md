...
Adobe Workfront Fusion 시나리오에서는 [!DNL OpenAI (ChatGPT & DALL-E)]를 사용하는 워크플로를 자동화할 수 있으며 여러 제3자 애플리케이션 및 서비스에 연결할 수 있습니다.
...
## Workfront Fusion에 [!DNL OpenAI (ChatGPT & DALL-E)] 연결 중
...
[!DNL OpenAI (ChatGPT & DALL-E)] 모듈을 구성할 때 Workfront Fusion은 아래 나열된 필드를 표시합니다. 이와 함께 앱 또는 서비스의 액세스 레벨과 같은 요인에 따라 추가적인 [!DNL OpenAI (ChatGPT & DALL-E)] 필드가 표시될 수 있습니다. 모듈의 굵은 글씨 제목은 필수 필드를 나타냅니다.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>[!DNL OpenAI (ChatGPT & DALL-E)] 계정을 Workfront Fusion에 연결하는 방법에 대한 지침은 이 문서의 <a href="#connecting-openaichatgpt-to-workfront-fusion" class="MCXref xref">Workfront Fusion에 [!DNL OpenAI (ChatGPT & DALL-E)] 연결</a>을 참조하십시오.</p> </td> 
  </tr> 
  <tr> 
