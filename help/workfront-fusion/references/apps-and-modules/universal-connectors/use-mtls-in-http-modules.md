...
[Workfront Fusion 2025 인증서 다운로드](assets/2025-certs/fusion-prod-mtls-certificate-2025.zip)

| 데이터 센터 | 파일 | 유효한 날짜 |
| --- | --- | --- |
| 미국 데이터 센터 | `fusion-prod-us-mtls-certificate.pem` | 2025년 3월 3일~2026년 4월 4일 |
| EU 데이터 센터 | `fusion-prod-eu-mtls-certificate.pem` | 2025년 3월 3일~2026년 4월 4일 |
| Azure 클러스터 | `fusion-prod-az-mtls-certificate.pem` | 2024년 10월 24일~2025년 11월 25일 |
