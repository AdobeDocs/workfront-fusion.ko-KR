...
title: Adobe User Management 모듈
description: Adobe Workfront Fusion 시나리오에서는 Adobe 계정의 사용자를 관리하는 워크플로를 자동화할 수 있습니다.
author: Becky
...
# Adobe User Management 모듈

Adobe Workfront Fusion 시나리오에서는 Adobe 계정의 사용자를 관리하는 워크플로를 자동화할 수 있습니다.
...
사용자의 [!DNL Adobe User Management] 모듈에 연결하려면:
...
Adobe 사용자 관리 모듈을 구성하면 Workfront Fusion에 아래 나열된 필드가 표시됩니다. 이러한 필드와 함께 앱이나 서비스의 액세스 수준 등의 요소에 따라 추가 Adobe 사용자 관리 필드가 표시될 수 있습니다. 모듈의 굵은 글씨 제목은 필수 필드를 나타냅니다.
