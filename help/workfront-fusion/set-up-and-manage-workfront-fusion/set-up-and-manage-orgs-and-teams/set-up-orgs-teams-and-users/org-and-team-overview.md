...
다음 리소스는 전체 Fusion 조직에 영향을 미치므로 조직 수준에서 소유 및 처리됩니다.

* **작업자 풀:**: 작업자 풀은 특정 조직 전용의 Workfront Fusion 처리 리소스 양입니다.

  자세한 내용은 [작업자 풀](/help/workfront-fusion/set-up-and-manage-workfront-fusion/licensing-operations-overview/worker-pools.md)을 참조하세요.

* **작업**: Adobe Workfront Fusion의 작업은 모듈에서 수행되는 작업입니다.

  자세한 내용은 [작업](/help/workfront-fusion/set-up-and-manage-workfront-fusion/licensing-operations-overview/operations-in-workfront-fusion.md)을 참조하십시오.
