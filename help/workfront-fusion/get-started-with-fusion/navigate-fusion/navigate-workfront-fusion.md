...
description: Fusion을 열면 다양한 액션 옵션이 있습니다. 이 문서는 앞으로 나아가야 할 방향을 이해하는 데 도움이 됩니다.
author: Becky
...
| 연결  <br> ![연결 아이콘](assets/connections-icon.png) | 연결에는 Fusion이 다른 애플리케이션과 상호 작용할 수 있도록 허용하는 로그인 자격 증명 및 권한이 포함되어 있습니다. 특정 애플리케이션에 대한 특정 자격 증명 및 권한 세트와 연결을 만든 다음 해당 연결을 시나리오에 사용합니다. 그런 다음 해당 자격 증명과 권한을 가진 사용자가 사용할 수 있는 레코드 또는 기타 데이터에 액세스하고 수정할 수 있습니다. 애플리케이션에 여러 개의 연결을 만들 수 있으며, 여러 시나리오에서 연결을 사용할 수 있습니다. 연결 영역에서 팀이 설정한 연결 목록을 보고 관리할 수 있습니다. | [연결 개요](/help/workfront-fusion/get-started-with-fusion/understand-fusion/connection-overview.md) |
