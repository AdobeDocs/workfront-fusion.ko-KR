...
* Fusion 릴리스 활동 {#fusion-release-activity}
   ...
   * Fusion 릴리스 - 2025 {#fusion-releases-2025}
      ...
      * [Workfront Fusion 릴리스 활동: 2025년 9월 22일의 주](/help/workfront-fusion/fusion-product-releases/fusion-releases-2025/fusion-2025-9-29.md)
...
* Workfront Fusion 설정 및 관리 {#set-up-and-manage-fusion}
   ...
   * 조직 및 팀 설정 및 관리 {#set-up-and-manage-orgs-and-teams}
      ...
      * 조직 및 팀 설정 {#set-up-orgs-teams-and-users}
         ...
         * [조직의 성과 대시보드 보기](/help/workfront-fusion/set-up-and-manage-workfront-fusion/set-up-and-manage-orgs-and-teams/set-up-orgs-teams-and-users/view-performace-dashboard.md)
