...
## [!DNL HubSpot CRM]에 Adobe Workfront Fusion 연결

[!DNL HubSpot CRM] 계정을 Workfront Fusion에 연결하는 방법에 대한 지침은 [Adobe Workfront Fusion 연결 만들기 - 기본 지침](/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md)을 참조하십시오.
...
[!DNL Hubspot CRM] 모듈을 구성할 때 Workfront Fusion은 아래 나열된 필드를 표시합니다. 이와 함께 앱 또는 서비스의 액세스 레벨과 같은 요인에 따라 추가적인 [!DNL Hubspot CRM] 필드가 표시될 수 있습니다. 모듈의 굵은 글씨 제목은 필수 필드를 나타냅니다.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL 검색]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL 제한]</td> 
   <td>한 시나리오 실행 주기 동안 Workfront Fusion이 반환해야 하는 최대 연락처 수입니다. </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL 출력 속성]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL 제한] </td> 
   <td>한 시나리오 실행 주기 동안 Workfront Fusion이 반환해야 하는 최대 연락처 수를 입력하거나 매핑합니다. </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL 제한]</td> 
   <td>한 시나리오 실행 주기 동안 Workfront Fusion이 반환해야 하는 최대 회사 수입니다. </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL 출력 속성]</td> 
   <td>모듈의 출력에 표시할 속성을 선택합니다. </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <li><b>메모</b><p>본문 필드에 메모 텍스트를 입력합니다.</p></li>
  </ul>
  </td> 
   </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>이 작업의 날짜를 입력하거나 매핑합니다.<p>지원되는 날짜 및 시간 형식 목록은 <a href="/help/workfront-fusion/references/mapping-panel/data-types/type-coercion.md" class="MCXref xref">유형 강제 변환</a>을 참조하십시오.</p></td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>브로드캐스트를 전송할 날짜 및 시간을 입력하거나 매핑합니다. 비워 두면 브로드캐스트가 즉시 전송됩니다.<p>지원되는 날짜 및 시간 형식 목록은 <a href="/help/workfront-fusion/references/mapping-panel/data-types/type-coercion.md" class="MCXref xref">유형 강제 변환</a>을 참조하십시오.</p></td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>블로그 게시물을 게시할 날짜를 입력하거나 매핑합니다. <p>지원되는 날짜 및 시간 형식 목록은 <a href="/help/workfront-fusion/references/mapping-panel/data-types/type-coercion.md" class="MCXref xref">유형 강제 변환</a>을 참조하십시오.</p></td> 
  </tr> 
  <tr> 
   <td role="rowheader">이름</td> 
