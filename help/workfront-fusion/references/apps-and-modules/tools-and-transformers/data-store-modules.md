...
>[!NOTE]
>
>같은 이름으로 데이터 저장소에 이미 있는 레코드를 추가하려고 하면 모듈에서 오류가 발생하고 [!UICONTROL Overwrite an existing record] 옵션이 비활성화됩니다.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p style="font-weight: normal;">정렬할 각 필드에 대해 다음 필드를 입력합니다.</p> <p style="font-weight: bold;">[!UICONTROL Key]</p> <p>결과를 정렬할 열 이름을 선택합니다.</p> <p style="font-weight: bold;">[!UICONTROL Order]</p> <p>결과를 오름차순으로 정렬할지 아니면 내림차순으로 정렬할지 선택합니다.</p> </td> 
  </tr> 
  <tr> 
