...
# Workfront Fusion 릴리스 활동: 2023년 8월 21일 주간
...
Workfront > 이벤트 보기 모듈의 이벤트 구독에 대한 자세한 내용은 Workfront > [!UICONTROL 이벤트 보기] 모듈에서 [이벤트 구독 필터](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/workfront-modules.md#event-subscription-filters-in-the-workfront--watch-events-modules)를 참조하십시오.
