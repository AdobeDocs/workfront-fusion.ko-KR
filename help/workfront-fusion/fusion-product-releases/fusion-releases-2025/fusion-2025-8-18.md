...
# Workfront Fusion 릴리스 활동: 2025년 8월 18일 주간

이 페이지에서는 2025년 8월 18일 화요일이 있는 주에 Adobe Workfront Fusion에서 이루어진 모든 개선 사항을 설명합니다.
...
모듈 구성을 더 쉽게 디버깅하거나 공유하기 위해 시나리오의 특정 모듈에 대한 링크를 만들 수 있도록 했습니다.특정 모듈에 대한 링크를 만들려면 다음 페이지를 볼 때 URL에 `?moduleId=<module-id>`을(를) 추가하십시오.
